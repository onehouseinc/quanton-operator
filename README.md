...
Both skills check prerequisites, handle errors, and give you live progress updates as jobs run on your local minikube cluster. You will need `onehouse-values.yaml` (from the [Onehouse ](https://www.onehouse.ai)) to install the Quanton Operator.
